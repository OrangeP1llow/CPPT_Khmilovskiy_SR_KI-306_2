...
public abstract class AssaultRifle {
    ...
    //конструктор для виклику в CustomAssaultRifle
    public AssaultRifle(String model, int ammunition, boolean enlargedMagazine) throws IOException {
        this.model = model;
        this.ammunition = ammunition;
        this.enlargedMagazine = enlargedMagazine;
        fout = new PrintWriter(new File("Log.txt"));
    ...
    public void weaponEnlargedMagazine(boolean enlargedMagazine, String enlargedMagazineType) {
        if (enlargedMagazine) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        /*AssaultRifle gun = new AssaultRifle("FAMAS", 25, 7.62, 3.6, 1500, false, true, false);
        gun.reload(10);
        gun.automaticFire(16);
        System.out.println();
        gun.burstFire(3);
        System.out.println();
        gun.singleFire(10);
        System.out.println();
        gun.setCaliber(5.45);
        gun.weaponScope(false, "0");
        gun.weaponMuffler(true, "baffle");
        gun.weaponEnlargedMagazine(false, "0");
        gun.closeLogFile();
        */
    }
}
