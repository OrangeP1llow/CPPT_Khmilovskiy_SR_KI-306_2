...
public class AssaultRifleApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            rifle = new CustomAssaultRifle(model, ammunition, caliber, weight, price, scope, muffler, enlargedMagazine);
        } catch (IOException e) {
            ...
            switch (choice) {
                ...
                case 8:
                    if (enlargedMagazine) {
                        ...
                        rifle.weaponEnlargedMagazine(true, newEnlargedMagazine);
                    } else {
